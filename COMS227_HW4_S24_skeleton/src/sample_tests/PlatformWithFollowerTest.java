...
public class PlatformWithFollowerTest {
	...
	public static void main(String[] args) {
		...
		b.addAssociated(e);
		System.out.println("Min: " +e.getMin()); // 50
		System.out.println("Max: " +e.getMax()); // 60
		...
		System.out.println("EXPECTED: 55, 60  " + e.getXReal() + ", " + (e.getXReal() + 5)); // expected 55, 60
		System.out.println();
		...
		System.out.println("bounds " + e.getMin() + ", " + e.getMax()); // 53, 63
		System.out.println("EXPECTED: 57, 62 ____ REAL:  " + e.getXReal() + ", " + (e.getXReal() + 5)); // 57, 62
		System.out.println("Base : " + b.getXReal()+ ",  " + (e.getXReal() + 10));
		System.out.println();
