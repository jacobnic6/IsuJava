...
public class LizardGame {
	...
	public void addWall(Wall wall) {
		...
		int col = wall.getCell().getCol();
		int row = wall.getCell().getRow();
		
		gameMap[row][col].placeWall(wall);
	...
	public void addExit(Exit exit) {
		int col = exit.getCell().getCol();
		int row = exit.getCell().getRow();
		
		gameMap[row][col].placeExit(exit);
		// TODO: method stub
	}
	...
	public void addLizard(Lizard lizard) {
		...
		for(BodySegment b : lizard.getSegments()) {
			int col = b.getCell().getCol();
			int row = b.getCell().getRow();
			gameMap[row][col].placeLizard(lizard);
		}
